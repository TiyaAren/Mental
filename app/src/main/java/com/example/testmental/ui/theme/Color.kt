...
val ColorWindForecast = Color.White.copy(alpha = 0.8f)
...
val ColorMoodFair = Color(0xFFDB8B3B)
val ColorMoodPoor = Color(0xFFCB1E00)
val ColorMoodTerrible = Color(0xFF8B0000)